...
<header class="blackNav" style="background-color: black;display: inline-block;width: 100%; height: 82px;">
    ...
    <button class="btn-secondary btn" class="clearfix"><a href="/restaurantes"> Restaurantes</a></button>
    ...
    <div id="js-pjax-container" data-pjax-container="" style="background-color: white";>
        <div class="container-lg clearfix px-3 mt-4" style="background-color: transparent">
            <div class="h-card col-3 float-left pr-3" style="background-color:white;">
                <span class="p-name vcard-fullname d-block overflow-hidden" itemprop="name">Hoteles</span>
                <hr>
...
<br>
<br>
<footer style="height: 65px;text-align: center;"> <span class="p-name vcard-fullname d-block overflow-hidden" itemprop="name">Hoteles | Antonio Nicolau Batle - Milestone  2 - FPGS 2º</span></footer>
</body>
</html>