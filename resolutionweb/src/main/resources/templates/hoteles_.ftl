            ...
            <#if uu??>
                <div class="card flex-md-row mb-4 shadow-sm h-md-250" style="background-color: #fed;">
                    <div class="card-body d-flex flex-column align-items-start">
                        ...
                        <div class="sm-2 text-primary position-relative clearfix">${uu.name}</div>
                        <div class="sm-1 text-muted float-right clearfix">${uu.imgUri}</div>
                        ...
                        <div class="card">
                            <div class="card-horizontal">
                                <div class="img-square-wrapper">
                                    <img class="card-img-left clearfix box" id="glx-7956-container" src="/img/Hilton.jpg" alt="Card image cap" style="width: 300px;height: 250px;">
                                </div>
                                <div class="card-body">
                                    <h4 class="card-title">${item.name}</h4>
                                    <h5 class="card-title">${item.id}</h5>
                                    <p class="card-text">${item.description}</p>
                                    <h3 class="card-title">${item.precio}</h3>
                                </div>
                            </div>
